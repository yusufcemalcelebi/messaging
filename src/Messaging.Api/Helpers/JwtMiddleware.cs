...
namespace Messaging.Api.Helpers
{
    public class JwtMiddleware
    {
        ...
        public JwtMiddleware(RequestDelegate next, IOptions<AuthenticationSettings> authenticationSettings)
        {
            _next = next;
        ...
        private async Task AttachUserToContextAsync(HttpContext context, IUserService _userService, string token)
        {
            try
            {
